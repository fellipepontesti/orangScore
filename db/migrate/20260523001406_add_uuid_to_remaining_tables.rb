class AddUuidToRemainingTables < ActiveRecord::Migration[7.1]
  TABLES = %i[selecoes palpites notificacoes cobrancas assinaturas pagamentos liga_membros user_points].freeze
